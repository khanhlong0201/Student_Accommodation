...
namespace BHSystem.API
{
    public interface IBHouseDbContext
    {
        Task Connect();
        Task DisConnect();
    ...
    public class BHouseDbContext : IBHouseDbContext
    {
        private readonly string _connectionString;
        private readonly IConfiguration _configuration;
        private SqlConnection? sqlConnection { get; set; }
        private SqlCommand? sqlCommand { get; set; }
        public BHouseDbContext(IConfiguration configuration)
        {
            _configuration = configuration;
            _connectionString = _configuration.GetConnectionString("BHouseConnection");
        }
